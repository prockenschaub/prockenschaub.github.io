...
excerpt: ""
permalink: /posts/2022/01/mice-for-predictions/
tags:
  - R language
  - validation 
...
It is well known that prediction models have a tendency to overfit to the training data, especially if we only have a limited amount of training data. While performance of such overfit models appears high when evaluated on the data available during training, their performance on new, previously unseen data is often considerably worse. Although it may be tempting to the analyst to choose a model with high training performance, it is the model's performance in future data that we really interested in. 
